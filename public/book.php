...
<div class="site-section py-5 home-intro">
  <div class="container ">
    ...
    <div id='service_info' class="container py-5">
      <div class="row text-primary text-center">
        <div class="col-sm-12  col-md-6 ">
          <h3 class="text-capitalize font-weight-bolder">waiting Customers</h3>
          <h3 id='waiting_customers' class="  p-3 text-dark"></h3>
        </div>
        <div class="col-sm-12 col-md-6 text-center">
          <h3 class="text-capitalize font-weight-bolder ">Estimated Time</h3>
