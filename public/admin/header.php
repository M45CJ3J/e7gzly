        ...
        <ul class="metismenu" id="menu">
          ...
          <li>
            ...
            <ul aria-expanded="false">
              <li><a href="branches.php">Branches List / Update</a></li>
          ...
          <li>
            ...
            <li>
              <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                <i class="fas fa-list"></i><span class="nav-text">Categories</span>
              </a>
              <ul aria-expanded="false">
            ...
            <li>
              <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                <i class="fas fa-sitemap"></i><span class="nav-text">Organizations</span>
              </a>
              <ul aria-expanded="false">
                <li><a href="orgs.php">Organizations</a></li>
                <li><a href="org_add.php">Organization Add</a></li>
              </ul>
            </li>
            <li class="nav-label">Org Users</li>
            <li>
              <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                <i class="fas fa-users"></i><span class="nav-text">Org Users</span>
              </a>
              <ul aria-expanded="false">
                <li><a href="org_users.php">Org Users</a></li>
                <li><a href="org_user_add.php">Org User Add</a></li>
              </ul>
            </li>
            <li class="nav-label">Misc</li>
            <li>
              <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                <i class="fas fa-address-book"></i><span class="nav-text">Misc</span>
              </a>
              <ul aria-expanded="false">
          ...
          <?php elseif (isset($_SESSION['user_id']) && $_SESSION['user_type'] == 3) : ?>
            ...
            <li>
              ...
              <ul aria-expanded="false">
                <li><a href="br_services.php">Services</a></li>
                <li><a href="br_service_add.php">Add Service</a></li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul aria-expanded="false">
                <li><a href="service_emp.php">Service Employee</a></li>
                <li><a href="service_emp_add.php">Add Employee</a></li>
              </ul>
            </li>
          <?php elseif (isset($_SESSION['user_id']) && $_SESSION['user_type'] == 2) : ?>
            ...
            <li>
              <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                <i class="fas fa-ticket-alt"></i><span class="nav-text">Dashboard</span>
              </a>
              <ul aria-expanded="false">
          ...
          <?php endif; ?>
          <?php if (isset($_SESSION['user_id']) && $_SESSION['user_type'] < 6) : ?>
