  ...
  <div class="container ">
    <div class="row ">
      <div class="col-12">
        ...
        <form id="reg_form" class="d-block mx-auto w-50 pb-3" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input id="email" class="form-control is-valid" name="email" placeholder="Email" type="email" required>
            <div id="mail_feedback" class=""></div>
          </div>
          <div class="form-group">
            <label for="phone">Phone</label>
            <input name="phone" class="form-control is-valid" placeholder="Phone" type="text" id="phone" minlength="8" maxlength="11" required>
