    ...
    $.ajax(`../../api.php?section=users&do=get_branch_employees`, {
      ...
      success: function (data, textStatus, jqXHR) {
        if (data == 'false') {
          ...
          $('#branch_employees tr:last').after(`<tr><td valign="top" colspan="9" class="dataTables_empty"><a href="employee_add.php"><button type="button" class="btn mb-1 btn-outline-info">Start Adding Employees</button></a> </td></tr>`);
