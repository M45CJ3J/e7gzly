    ...
    <div class="col-12 col-md-6 offset-md-3">
      <form id="profile-form" class="d-block mx-auto pb-3" action="" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control" minlength="10" maxlength="40" value="<?php echo isset($_POST['_name']) ? $_POST['_name'] : '' ?>" name="_name" placeholder="Full Name" type="text" id="_name" required>
            <div id="name_feedback" class=""></div>
          </div>
          <div class="form-group">
            <label for="phone">Phone</label>
            <input class="form-control is-valid" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : ''; ?>" name="phone" placeholder="Phone" type="text" id="phone" minlength="8" maxlength="11" required>
            <div id="phone_feedback" class=""></div>
          </div>
          <div class="form-group">
            <label for="address">Address</label>
            <input class="form-control" minlength="15" maxlength="100" value="<?php echo isset($_POST['address']) ? $_POST['address'] : '' ?>" name="address" placeholder="Address" type="text" id="address" required>
